...
//  }
    ...
    dh File.SINGLEPLAYER_VICTORY_IMAGE_BOTTOM               // SNAKE
    ...
    add_to_single_player(Character.id.SNAKE,   name_texture.WARIO,   name_delay.SNAKE)
