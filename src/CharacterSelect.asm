...
//      addiu   v0, sp, 0x0000                  // original line 1
    ...
    scope load_additional_characters_: {
        ...
        lli     a0, Character.id.SPM        // a0 = ZERO
        beql    a0, s0, _loop               // if char_id = ZERO, skip
        addiu   s0, s0, 0x0001              // increment index
        lli     a0, Character.id.ZERO       // a0 = SPM
        beql    a0, s0, _loop               // if char_id = SPM, skip
        addiu   s0, s0, 0x0001              // increment index      
...
//      lhu     a0, 0x0020(a0)              // original line 4
    ...
    //@ Description
    //CHARACTER SELECT SCREEN LAYOUT (for 2 new columns)
    ...
    add_to_css(Character.id.ELINK,  FGM.announcer.names.ELINK,          1.50,         0x00010001, ZELDA,        name_texture.LINK,           portrait_offsets.ELINK,          6)
    add_to_css(Character.id.JSAMUS, FGM.announcer.names.SAMUS,          1.50,         0x00010003, METROID,      name_texture.SAMUS,          portrait_offsets.JSAMUS,         7)
    add_to_css(Character.id.JNESS,  FGM.announcer.names.NESS,           1.50,         0x00010002, EARTHBOUND,   name_texture.NESS,           portrait_offsets.JNESS,          15)
    ...
    add_to_css(Character.id.JLINK,  FGM.announcer.names.LINK,           1.50,         0x00010001, ZELDA,        name_texture.LINK,           portrait_offsets.JLINK,          6)
    add_to_css(Character.id.JFALCON,FGM.announcer.names.CAPTAIN_FALCON, 1.50,         0x00010001, FZERO,        name_texture.CAPTAIN_FALCON, portrait_offsets.JFALCON,        8)
    add_to_css(Character.id.JFOX,   FGM.announcer.names.JFOX,           1.50,         0x00010004, STARFOX,      name_texture.FOX,            portrait_offsets.JFOX,           18)
    add_to_css(Character.id.JMARIO, FGM.announcer.names.MARIO,          1.50,         0x00010003, MARIO_BROS,   name_texture.MARIO,          portrait_offsets.JMARIO,         4)
    add_to_css(Character.id.JLUIGI, FGM.announcer.names.LUIGI,          1.50,         0x00010001, MARIO_BROS,   name_texture.LUIGI,          portrait_offsets.JLUIGI,         3)
    add_to_css(Character.id.JDK,    FGM.announcer.names.DONKEY_KONG,    2,            0x00010001, DONKEY_KONG,  name_texture.JDK,            portrait_offsets.JDK,            5)
    add_to_css(Character.id.EPIKA,  FGM.announcer.names.PIKACHU,        1.50,         0x00010001, POKEMON,      name_texture.PIKACHU,        portrait_offsets.EPIKA,          19)
    add_to_css(Character.id.JPUFF,  FGM.announcer.names.JPUFF,          1.50,         0x00010002, POKEMON,      name_texture.JPUFF,          portrait_offsets.JPUFF,          20)
    add_to_css(Character.id.EPUFF,  FGM.announcer.names.EPUFF,          1.50,         0x00010002, POKEMON,      name_texture.EPUFF,          portrait_offsets.EPUFF,          20)
    add_to_css(Character.id.JKIRBY, FGM.announcer.names.KIRBY,          1.50,         0x00010003, KIRBY,        name_texture.KIRBY,          portrait_offsets.JKIRBY,         17)
    add_to_css(Character.id.JYOSHI, FGM.announcer.names.YOSHI,          1.50,         0x00010002, YOSHI,        name_texture.YOSHI,          portrait_offsets.JYOSHI,         16)
    add_to_css(Character.id.JPIKA,  FGM.announcer.names.PIKACHU,        1.50,         0x00010001, POKEMON,      name_texture.PIKACHU,        portrait_offsets.JPIKA,          19)
    add_to_css(Character.id.ESAMUS, FGM.announcer.names.ESAMUS,         1.50,         0x00010003, METROID,      name_texture.SAMUS,          portrait_offsets.ESAMUS,         7)
    ...
    add_to_css(Character.id.GBOWSER,FGM.announcer.names.GBOWSER,        2.25,         0x00010002, BOWSER,       name_texture.GBOWSER,        portrait_offsets.GBOWSER,        29)
    add_to_css(Character.id.PIANO,  FGM.announcer.names.PIANO,          2,            0x00010004, MARIO_BROS,   name_texture.PIANO,          portrait_offsets.PIANO,          17)
    ...
    add_to_css(Character.id.SSONIC, FGM.announcer.names.SSONIC,        	1.50,         0x00010004, SONIC,        name_texture.SSONIC,         portrait_offsets.SSONIC,         10)
    ...
    add_to_css(Character.id.PEPPY,  FGM.announcer.names.PEPPY,          1.50,         0x00010004, STARFOX,      name_texture.PEPPY,          portrait_offsets.PEPPY,          18)
    add_to_css(Character.id.SLIPPY, FGM.announcer.names.SLIPPY,         1.50,         0x00010004, STARFOX,      name_texture.SLIPPY,         portrait_offsets.SLIPPY,         21)
    ...
    // REMIX POLYGONS
    add_to_css(Character.id.NWARIO, FGM.announcer.names.NWARIO,         1.50,         0x00010004, SMASH,        name_texture.NWARIO,         portrait_offsets.WARIO,          27)
    add_to_css(Character.id.NLUCAS, FGM.announcer.names.NLUCAS,         1.50,         0x00010002, SMASH,        name_texture.NLUCAS,         portrait_offsets.LUCAS,          28)
    add_to_css(Character.id.NBOWSER, FGM.announcer.names.NBOWSER,       2,            0x00010002, SMASH,        name_texture.NBOWSER,        portrait_offsets.BOWSER,         29)
    add_to_css(Character.id.NWOLF,  FGM.announcer.names.NWOLF,          1.50,         0x00010004, SMASH,        name_texture.NWOLF,          portrait_offsets.WOLF,           30)
    add_to_css(Character.id.NDRM,   FGM.announcer.names.NDR_MARIO,      1.50,         0x00010001, SMASH,        name_texture.NDRM,           portrait_offsets.DRM,            2)
    add_to_css(Character.id.NSONIC, FGM.announcer.names.NSONIC,        	1.50,         0x00010004, SMASH,        name_texture.NSONIC,         portrait_offsets.SONIC,          10)
    add_to_css(Character.id.NSHEIK, FGM.announcer.names.NSHEIK,         1.50,         0x00010001, SMASH,        name_texture.NSHEIK,         portrait_offsets.SHEIK,          22)
    add_to_css(Character.id.NMARINA, FGM.announcer.names.NMARINA,       1.50,         0x00010001, SMASH,        name_texture.NMARINA,        portrait_offsets.MARINA,         1)
    add_to_css(Character.id.NFALCO,  FGM.announcer.names.NFALCO,        1.50,         0x00010004, SMASH,        name_texture.NFALCO,         portrait_offsets.FALCO,          21)
    add_to_css(Character.id.NGND, FGM.announcer.names.NGANONDORF,       1.50,         0x00010002, SMASH,        name_texture.NGND,           portrait_offsets.GND,            9)
    add_to_css(Character.id.NDSAMUS, FGM.announcer.names.NDSAMUS,       1.50,         0x00010004, SMASH,        name_texture.NDSAMUS,        portrait_offsets.DSAMUS,         26)
    add_to_css(Character.id.NMARTH, FGM.announcer.names.NMARTH,         1.50,         0x00010004, SMASH,        name_texture.NMARTH,         portrait_offsets.MARTH,          33)
    add_to_css(Character.id.NMTWO, FGM.announcer.names.NMTWO,           1.50,         0x00010004, SMASH,        name_texture.NMTWO,          portrait_offsets.MTWO,           32)
    add_to_css(Character.id.NDEDEDE, FGM.announcer.names.NDEDEDE,       2,            0x00010001, SMASH,        name_texture.NDEDEDE,        portrait_offsets.DEDEDE,         13)
    add_to_css(Character.id.NYLINK, FGM.announcer.names.NYLINK,         1.50,         0x00010002, SMASH,        name_texture.NYLINK,         portrait_offsets.YLINK,          14)
