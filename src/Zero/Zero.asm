...
scope Zero {
    ...
    Character.edit_action_parameters(ZERO, 0xE4,                          File.ZERO_ACTION_0E4,            -1,                     -1)
    Character.edit_action_parameters(ZERO, 0xE5,                          File.ZERO_ACTION_0E4,            -1,                     -1)
    Character.edit_action_parameters(ZERO, 0xEB,                          File.ZERO_ACTION_0EE,            -1,                      -1)
    Character.edit_action_parameters(ZERO, 0xEC,                          File.ZERO_ACTION_0EC,            -1,        0x40000000)
    Character.edit_action_parameters(ZERO, 0xEE,                          File.ZERO_ACTION_0EE,            -1,                      -1)
    Character.edit_action_parameters(ZERO, 0xE8,                          File.ZERO_ACTION_0E8,            -1,               -1)
    Character.edit_action_parameters(ZERO, 0xE9,                          File.ZERO_ACTION_0E9,            -1,                   -1)

    Character.edit_action_parameters(ZERO, Action.DamageHigh1,     File.ZERO_DAMAGEHIGH1,                        -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageHigh2,     File.ZERO_DAMAGEHIGH2,                        -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageHigh3,     File.ZERO_DAMAGEHIGH3,                        -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageMid1,      File.ZERO_DAMAGEMID1,                         -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageMid2,      File.ZERO_DAMAGEMID2,                         -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageMid3,      File.ZERO_DAMAGEMID3,                         -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageLow1,      File.ZERO_DAMAGELOW1,                         -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageLow2,      File.ZERO_DAMAGELOW2,                         -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageLow3,      File.ZERO_DAMAGELOW3,                         -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageAir1,      File.ZERO_DAMAGEAIR1,                         -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageAir2,      File.ZERO_DAMAGEAIR2,                         -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageAir3,      File.ZERO_DAMAGEAIR3,                         -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageElec1,     File.ZERO_DAMAGEELEC,                         -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageElec2,     File.ZERO_DAMAGEELEC,                         -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageFlyHigh,   File.ZERO_DAMAGEFLYHIGH,                      -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageFlyMid,    File.ZERO_DAMAGEFLYMID,                       -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageFlyLow,    File.ZERO_DAMAGEFLYLOW,                       -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageFlyTop,    File.ZERO_DAMAGEFLYTOP,                       -1,                      -1)
    Character.edit_action_parameters(ZERO, Action.DamageFlyRoll,   File.ZERO_DAMAGEFLYROLL,                      -1,                      -1)
    ...
    Character.edit_menu_action_parameters(ZERO,   0xE,               File.ZERO_CPU_POSE,          -1,                      -1)
    ...
    Teams.add_team_costume(YELLOW, ZERO, 0x6)
