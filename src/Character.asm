...
scope Character {
    ...
    // 0x4A - ZERO
    define_character(ZERO, CAPTAIN, File.ZERO_MAIN, 0x0EB, 0, File.ZERO_CHARACTER, 0x14E, 0, 0x15E, 0x14D, 0, 0x500, 0x0, OS.TRUE, OS.FALSE, Stages.id.BTT_FALCON, Stages.id.BTP_FALCON, Stages.id.BTT_GND, Stages.id.BTP_GND, sound_type.U, variant_type.NA)
